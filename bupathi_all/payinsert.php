...
$sql = $sql = "INSERT INTO userpayment (email, phone, NIC, packege, addtional_s, bank,holder_name,card_no,expire_date,cvv) 
...
if($conn->query($sql))
{
  ...
  header("Location:http://localhost/php/payinfo.php");
  exit;
}
